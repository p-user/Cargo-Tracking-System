...
{
    public class OrderCreatedIntegrationEventHandler(ILogger<OrderCreatedIntegrationEventHandler> _logger, IRoutingApplicationService _routingService) : IConsumer<OrderCreatedIntegrationEvent>
    {
